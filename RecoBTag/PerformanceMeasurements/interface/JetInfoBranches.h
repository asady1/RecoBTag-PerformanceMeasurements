...
const UInt_t nMaxSubjetsIn_=10000;
...
class JetInfoBranches {
  ...
  public :
    ...
    float Jet_tauAxis3_px[nMaxJets_];
    float Jet_tauAxis3_py[nMaxJets_];
    float Jet_tauAxis3_pz[nMaxJets_];
    ...
    float Jet_LSF_lepPT[nMaxJets_];
    float Jet_LSF_lepETA[nMaxJets_];
    float Jet_LSF_lepPHI[nMaxJets_];
    float Jet_LSF_lepTYPE[nMaxJets_];
    float Jet_LSF_ExkT2_LSF[nMaxJets_];
    float Jet_LSF_ExkT2_LMD[nMaxJets_];
    float Jet_LSF_ExkT2_sjIndex[nMaxJets_];
    float Jet_LSF_ExkT2_sj1PT[nMaxJets_];
    float Jet_LSF_ExkT2_sj1ETA[nMaxJets_];
    float Jet_LSF_ExkT2_sj1PHI[nMaxJets_];
    float Jet_LSF_ExkT2_sj1M[nMaxJets_];
    float Jet_LSF_ExkT2_sj2PT[nMaxJets_];
    float Jet_LSF_ExkT2_sj2ETA[nMaxJets_];
    float Jet_LSF_ExkT2_sj2PHI[nMaxJets_];
    float Jet_LSF_ExkT2_sj2M[nMaxJets_];
    float Jet_LSF_ExkT3_LSF[nMaxJets_];
    float Jet_LSF_ExkT3_LMD[nMaxJets_];
    float Jet_LSF_ExkT3_sjIndex[nMaxJets_];
    float Jet_LSF_ExkT3_sj1PT[nMaxJets_];
    float Jet_LSF_ExkT3_sj1ETA[nMaxJets_];
    float Jet_LSF_ExkT3_sj1PHI[nMaxJets_];
    float Jet_LSF_ExkT3_sj1M[nMaxJets_];
    float Jet_LSF_ExkT3_sj2PT[nMaxJets_];
    float Jet_LSF_ExkT3_sj2ETA[nMaxJets_];
    float Jet_LSF_ExkT3_sj2PHI[nMaxJets_];
    float Jet_LSF_ExkT3_sj2M[nMaxJets_];
    float Jet_LSF_ExkT3_sj3PT[nMaxJets_];
    float Jet_LSF_ExkT3_sj3ETA[nMaxJets_];
    float Jet_LSF_ExkT3_sj3PHI[nMaxJets_];
    float Jet_LSF_ExkT3_sj3M[nMaxJets_];
    float Jet_LSF_ExkT4_LSF[nMaxJets_];
    float Jet_LSF_ExkT4_LMD[nMaxJets_];
    float Jet_LSF_ExkT4_sjIndex[nMaxJets_];
    float Jet_LSF_ExkT4_sj1PT[nMaxJets_];
    float Jet_LSF_ExkT4_sj1ETA[nMaxJets_];
    float Jet_LSF_ExkT4_sj1PHI[nMaxJets_];
    float Jet_LSF_ExkT4_sj1M[nMaxJets_];
    float Jet_LSF_ExkT4_sj2PT[nMaxJets_];
    float Jet_LSF_ExkT4_sj2ETA[nMaxJets_];
    float Jet_LSF_ExkT4_sj2PHI[nMaxJets_];
    float Jet_LSF_ExkT4_sj2M[nMaxJets_];
    float Jet_LSF_ExkT4_sj3PT[nMaxJets_];
    float Jet_LSF_ExkT4_sj3ETA[nMaxJets_];
    float Jet_LSF_ExkT4_sj3PHI[nMaxJets_];
    float Jet_LSF_ExkT4_sj3M[nMaxJets_];
    float Jet_LSF_ExkT4_sj4PT[nMaxJets_];
    float Jet_LSF_ExkT4_sj4ETA[nMaxJets_];
    float Jet_LSF_ExkT4_sj4PHI[nMaxJets_];
    float Jet_LSF_ExkT4_sj4M[nMaxJets_];
    int nSubjetsIn;
    float Jet_LSF_Incl_LSF[nMaxJets_];
    float Jet_LSF_Incl_LMD[nMaxJets_];
    float Jet_LSF_Incl_sjIndex[nMaxJets_];
    float Jet_LSF_Incl_nSubjets[nMaxJets_];
    float Jet_LSF_Incl_sjPT[nMaxSubjetsIn_];
    float Jet_LSF_Incl_sjETA[nMaxSubjetsIn_];
    float Jet_LSF_Incl_sjPHI[nMaxSubjetsIn_];
    float Jet_LSF_Incl_sjM[nMaxSubjetsIn_];

    float Jet_e2_b1[nMaxJets_];
    float Jet_e3_b1[nMaxJets_];
    float Jet_e3_v1_b1[nMaxJets_];
    float Jet_e3_v2_b1[nMaxJets_];
    float Jet_e4_v1_b1[nMaxJets_];
    float Jet_e4_v2_b1[nMaxJets_];
    float Jet_e2_b2[nMaxJets_];
    float Jet_e3_b2[nMaxJets_];
    float Jet_e3_v1_b2[nMaxJets_];
    float Jet_e3_v2_b2[nMaxJets_];
    float Jet_e4_v1_b2[nMaxJets_];
    float Jet_e4_v2_b2[nMaxJets_];
    /*    float Jet_e2_sdb1[nMaxJets_];
    float Jet_e3_sdb1[nMaxJets_];
    float Jet_e3_v1_sdb1[nMaxJets_];
    float Jet_e3_v2_sdb1[nMaxJets_];
    float Jet_e4_v1_sdb1[nMaxJets_];
    float Jet_e4_v2_sdb1[nMaxJets_];
    float Jet_e2_sdb2[nMaxJets_];
    float Jet_e3_sdb2[nMaxJets_];
    float Jet_e3_v1_sdb2[nMaxJets_];
    float Jet_e3_v2_sdb2[nMaxJets_];
    float Jet_e4_v1_sdb2[nMaxJets_];
    float Jet_e4_v2_sdb2[nMaxJets_];
    */
    int   nTrack;
    ...
    void RegisterTree(TTree *tree, std::string name="") {
      ...
      tree->Branch((name+"Jet_LSF_lepPT").c_str(),     Jet_LSF_lepPT     ,(name+"Jet_LSF_lepPT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_lepETA").c_str(),     Jet_LSF_lepETA     ,(name+"Jet_LSF_lepETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_lepPHI").c_str(),     Jet_LSF_lepPHI     ,(name+"Jet_LSF_lepPHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_lepTYPE").c_str(),     Jet_LSF_lepTYPE     ,(name+"Jet_LSF_lepTYPE["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_LSF").c_str(),     Jet_LSF_ExkT2_LSF     ,(name+"Jet_LSF_ExkT2_LSF["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_LMD").c_str(),     Jet_LSF_ExkT2_LMD     ,(name+"Jet_LSF_ExkT2_LMD["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_sjIndex").c_str(),     Jet_LSF_ExkT2_sjIndex     ,(name+"Jet_LSF_ExkT2_sjIndex["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_sj1PT").c_str(),     Jet_LSF_ExkT2_sj1PT     ,(name+"Jet_LSF_ExkT2_sj1PT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_sj1ETA").c_str(),     Jet_LSF_ExkT2_sj1ETA     ,(name+"Jet_LSF_ExkT2_sj1ETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_sj1PHI").c_str(),     Jet_LSF_ExkT2_sj1PHI     ,(name+"Jet_LSF_ExkT2_sj1PHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_sj1M").c_str(),     Jet_LSF_ExkT2_sj1M     ,(name+"Jet_LSF_ExkT2_sj1M["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_sj2PT").c_str(),     Jet_LSF_ExkT2_sj2PT     ,(name+"Jet_LSF_ExkT2_sj2PT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_sj2ETA").c_str(),     Jet_LSF_ExkT2_sj2ETA     ,(name+"Jet_LSF_ExkT2_sj2ETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_sj2PHI").c_str(),     Jet_LSF_ExkT2_sj2PHI     ,(name+"Jet_LSF_ExkT2_sj2PHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT2_sj2M").c_str(),     Jet_LSF_ExkT2_sj2M     ,(name+"Jet_LSF_ExkT2_sj2M["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_LSF").c_str(),     Jet_LSF_ExkT3_LSF     ,(name+"Jet_LSF_ExkT3_LSF["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_LMD").c_str(),     Jet_LSF_ExkT3_LMD     ,(name+"Jet_LSF_ExkT3_LMD["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sjIndex").c_str(),     Jet_LSF_ExkT3_sjIndex     ,(name+"Jet_LSF_ExkT3_sjIndex["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj1PT").c_str(),     Jet_LSF_ExkT3_sj1PT     ,(name+"Jet_LSF_ExkT3_sj1PT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj1ETA").c_str(),     Jet_LSF_ExkT3_sj1ETA     ,(name+"Jet_LSF_ExkT3_sj1ETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj1PHI").c_str(),     Jet_LSF_ExkT3_sj1PHI     ,(name+"Jet_LSF_ExkT3_sj1PHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj1M").c_str(),     Jet_LSF_ExkT3_sj1M     ,(name+"Jet_LSF_ExkT3_sj1M["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj2PT").c_str(),     Jet_LSF_ExkT3_sj2PT     ,(name+"Jet_LSF_ExkT3_sj2PT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj2ETA").c_str(),     Jet_LSF_ExkT3_sj2ETA     ,(name+"Jet_LSF_ExkT3_sj2ETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj2PHI").c_str(),     Jet_LSF_ExkT3_sj2PHI     ,(name+"Jet_LSF_ExkT3_sj2PHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj2M").c_str(),     Jet_LSF_ExkT3_sj2M     ,(name+"Jet_LSF_ExkT3_sj2M["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj3PT").c_str(),     Jet_LSF_ExkT3_sj3PT     ,(name+"Jet_LSF_ExkT3_sj3PT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj3ETA").c_str(),     Jet_LSF_ExkT3_sj3ETA     ,(name+"Jet_LSF_ExkT3_sj3ETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj3PHI").c_str(),     Jet_LSF_ExkT3_sj3PHI     ,(name+"Jet_LSF_ExkT3_sj3PHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT3_sj3M").c_str(),     Jet_LSF_ExkT3_sj3M     ,(name+"Jet_LSF_ExkT3_sj3M["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_LSF").c_str(),     Jet_LSF_ExkT4_LSF     ,(name+"Jet_LSF_ExkT4_LSF["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_LMD").c_str(),     Jet_LSF_ExkT4_LMD     ,(name+"Jet_LSF_ExkT4_LMD["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sjIndex").c_str(),     Jet_LSF_ExkT4_sjIndex     ,(name+"Jet_LSF_ExkT4_sjIndex["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj1PT").c_str(),     Jet_LSF_ExkT4_sj1PT     ,(name+"Jet_LSF_ExkT4_sj1PT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj1ETA").c_str(),     Jet_LSF_ExkT4_sj1ETA     ,(name+"Jet_LSF_ExkT4_sj1ETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj1PHI").c_str(),     Jet_LSF_ExkT4_sj1PHI     ,(name+"Jet_LSF_ExkT4_sj1PHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj1M").c_str(),     Jet_LSF_ExkT4_sj1M     ,(name+"Jet_LSF_ExkT4_sj1M["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj2PT").c_str(),     Jet_LSF_ExkT4_sj2PT     ,(name+"Jet_LSF_ExkT4_sj2PT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj2ETA").c_str(),     Jet_LSF_ExkT4_sj2ETA     ,(name+"Jet_LSF_ExkT4_sj2ETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj2PHI").c_str(),     Jet_LSF_ExkT4_sj2PHI     ,(name+"Jet_LSF_ExkT4_sj2PHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj2M").c_str(),     Jet_LSF_ExkT4_sj2M     ,(name+"Jet_LSF_ExkT4_sj2M["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj3PT").c_str(),     Jet_LSF_ExkT4_sj3PT     ,(name+"Jet_LSF_ExkT4_sj3PT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj3ETA").c_str(),     Jet_LSF_ExkT4_sj3ETA     ,(name+"Jet_LSF_ExkT4_sj3ETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj3PHI").c_str(),     Jet_LSF_ExkT4_sj3PHI     ,(name+"Jet_LSF_ExkT4_sj3PHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj3M").c_str(),     Jet_LSF_ExkT4_sj3M     ,(name+"Jet_LSF_ExkT4_sj3M["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj4PT").c_str(),     Jet_LSF_ExkT4_sj4PT     ,(name+"Jet_LSF_ExkT4_sj4PT["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj4ETA").c_str(),     Jet_LSF_ExkT4_sj4ETA     ,(name+"Jet_LSF_ExkT4_sj4ETA["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj4PHI").c_str(),     Jet_LSF_ExkT4_sj4PHI     ,(name+"Jet_LSF_ExkT4_sj4PHI["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_ExkT4_sj4M").c_str(),     Jet_LSF_ExkT4_sj4M     ,(name+"Jet_LSF_ExkT4_sj4M["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"nSubjetsIn").c_str()         , &nSubjetsIn,      (name+"nSubjetsIn/I").c_str());
      tree->Branch((name+"Jet_LSF_Incl_LSF").c_str(),     Jet_LSF_Incl_LSF     ,(name+"Jet_LSF_Incl_LSF["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_Incl_LMD").c_str(),     Jet_LSF_Incl_LMD     ,(name+"Jet_LSF_Incl_LMD["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_Incl_sjIndex").c_str(),     Jet_LSF_Incl_sjIndex    ,(name+"Jet_LSF_Incl_sjIndex["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_Incl_nSubjets").c_str(),     Jet_LSF_Incl_nSubjets     ,(name+"Jet_LSF_Incl_nSubjets["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_Incl_sjPT").c_str(),            Jet_LSF_Incl_sjPT      ,(name+"Jet_LSF_Incl_sjPT["+name+"nSubjetsIn]/F").c_str());
      tree->Branch((name+"Jet_LSF_Incl_sjETA").c_str(),            Jet_LSF_Incl_sjETA      ,(name+"Jet_LSF_Incl_sjETA["+name+"nSubjetsIn]/F").c_str());
      tree->Branch((name+"Jet_LSF_Incl_sjPHI").c_str(),            Jet_LSF_Incl_sjPHI      ,(name+"Jet_LSF_Incl_sjPHI["+name+"nSubjetsIn]/F").c_str());
      tree->Branch((name+"Jet_LSF_Incl_sjM").c_str(),            Jet_LSF_Incl_sjM      ,(name+"Jet_LSF_Incl_sjM["+name+"nSubjetsIn]/F").c_str());
    ...
    void RegisterFatJetSpecificTree(TTree *tree, std::string name="", bool trackVars=false) {
      ...
      tree->Branch((name+"Jet_tau3").c_str(),        Jet_tau3        ,(name+"Jet_tau3["+name+"nJet]/F").c_str());
      ...
      tree->Branch((name+"Jet_tauAxis3_px").c_str(), Jet_tauAxis3_px ,(name+"Jet_tauAxis3_px["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_tauAxis3_py").c_str(), Jet_tauAxis3_py ,(name+"Jet_tauAxis3_py["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_tauAxis3_pz").c_str(), Jet_tauAxis3_pz ,(name+"Jet_tauAxis3_pz["+name+"nJet]/F").c_str());
      ...
      tree->Branch((name+"Jet_e2_b1").c_str(),        Jet_e2_b1        ,(name+"Jet_e2_b1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_b1").c_str(),        Jet_e3_b1        ,(name+"Jet_e3_b1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_v1_b1").c_str(),        Jet_e3_v1_b1        ,(name+"Jet_e3_v1_b1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_v2_b1").c_str(),        Jet_e3_v2_b1        ,(name+"Jet_e3_v2_b1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e4_v1_b1").c_str(),        Jet_e4_v1_b1        ,(name+"Jet_e4_v1_b1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e4_v2_b1").c_str(),        Jet_e4_v2_b1        ,(name+"Jet_e4_v2_b1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e2_b2").c_str(),        Jet_e2_b2        ,(name+"Jet_e2_b2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_b2").c_str(),        Jet_e3_b2        ,(name+"Jet_e3_b2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_v1_b2").c_str(),        Jet_e3_v1_b2        ,(name+"Jet_e3_v1_b2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_v2_b2").c_str(),        Jet_e3_v2_b2        ,(name+"Jet_e3_v2_b2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e4_v1_b2").c_str(),        Jet_e4_v1_b2        ,(name+"Jet_e4_v1_b2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e4_v2_b2").c_str(),        Jet_e4_v2_b2        ,(name+"Jet_e4_v2_b2["+name+"nJet]/F").c_str());
      /*tree->Branch((name+"Jet_e2_sdb1").c_str(),        Jet_e2_sdb1        ,(name+"Jet_e2_sdb1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_sdb1").c_str(),        Jet_e3_sdb1        ,(name+"Jet_e3_sdb1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_v1_sdb1").c_str(),        Jet_e3_v1_sdb1        ,(name+"Jet_e3_v1_sdb1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_v2_sdb1").c_str(),        Jet_e3_v2_sdb1        ,(name+"Jet_e3_v2_sdb1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e4_v1_sdb1").c_str(),        Jet_e4_v1_sdb1        ,(name+"Jet_e4_v1_sdb1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e4_v2_sdb1").c_str(),        Jet_e4_v2_sdb1        ,(name+"Jet_e4_v2_sdb1["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e2_sdb2").c_str(),        Jet_e2_sdb2        ,(name+"Jet_e2_sdb2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_sdb2").c_str(),        Jet_e3_sdb2        ,(name+"Jet_e3_sdb2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_v1_sdb2").c_str(),        Jet_e3_v1_sdb2        ,(name+"Jet_e3_v1_sdb2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e3_v2_sdb2").c_str(),        Jet_e3_v2_sdb2        ,(name+"Jet_e3_v2_sdb2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e4_v1_sdb2").c_str(),        Jet_e4_v1_sdb2        ,(name+"Jet_e4_v1_sdb2["+name+"nJet]/F").c_str());
      tree->Branch((name+"Jet_e4_v2_sdb2").c_str(),        Jet_e4_v2_sdb2        ,(name+"Jet_e4_v2_sdb2["+name+"nJet]/F").c_str());
      */
      if (trackVars)
      {
        TBranch* br = (TBranch*)tree->GetListOfBranches()->FindObject(TString((name+"nTrack").c_str()));
    ...
    void ReadTree(TTree *tree, std::string name="") {
      ...
      tree->SetBranchAddress((name+"Jet_LSF_lepPT").c_str(),     Jet_LSF_lepPT    );
      tree->SetBranchAddress((name+"Jet_LSF_lepETA").c_str(),     Jet_LSF_lepETA    );
      tree->SetBranchAddress((name+"Jet_LSF_lepPHI").c_str(),     Jet_LSF_lepPHI    );
      tree->SetBranchAddress((name+"Jet_LSF_lepTYPE").c_str(),     Jet_LSF_lepTYPE    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_LSF").c_str(),     Jet_LSF_ExkT2_LSF    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_LMD").c_str(),     Jet_LSF_ExkT2_LMD    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_sjIndex").c_str(),     Jet_LSF_ExkT2_sjIndex    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_sj1PT").c_str(),     Jet_LSF_ExkT2_sj1PT    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_sj1ETA").c_str(),     Jet_LSF_ExkT2_sj1ETA    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_sj1PHI").c_str(),     Jet_LSF_ExkT2_sj1PHI    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_sj1M").c_str(),     Jet_LSF_ExkT2_sj1M    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_sj2PT").c_str(),     Jet_LSF_ExkT2_sj2PT    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_sj2ETA").c_str(),     Jet_LSF_ExkT2_sj2ETA    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_sj2PHI").c_str(),     Jet_LSF_ExkT2_sj2PHI    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT2_sj2M").c_str(),     Jet_LSF_ExkT2_sj2M    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_LSF").c_str(),     Jet_LSF_ExkT3_LSF    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_LMD").c_str(),     Jet_LSF_ExkT3_LMD    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sjIndex").c_str(),     Jet_LSF_ExkT3_sjIndex    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj1PT").c_str(),     Jet_LSF_ExkT3_sj1PT    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj1ETA").c_str(),     Jet_LSF_ExkT3_sj1ETA    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj1PHI").c_str(),     Jet_LSF_ExkT3_sj1PHI    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj1M").c_str(),     Jet_LSF_ExkT3_sj1M    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj2PT").c_str(),     Jet_LSF_ExkT3_sj2PT    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj2ETA").c_str(),     Jet_LSF_ExkT3_sj2ETA    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj2PHI").c_str(),     Jet_LSF_ExkT3_sj2PHI    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj2M").c_str(),     Jet_LSF_ExkT3_sj2M    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj3PT").c_str(),     Jet_LSF_ExkT3_sj3PT    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj3ETA").c_str(),     Jet_LSF_ExkT3_sj3ETA    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj3PHI").c_str(),     Jet_LSF_ExkT3_sj3PHI    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT3_sj3M").c_str(),     Jet_LSF_ExkT3_sj3M    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_LSF").c_str(),     Jet_LSF_ExkT4_LSF    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_LMD").c_str(),     Jet_LSF_ExkT4_LMD    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sjIndex").c_str(),     Jet_LSF_ExkT4_sjIndex    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj1PT").c_str(),     Jet_LSF_ExkT4_sj1PT    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj1ETA").c_str(),     Jet_LSF_ExkT4_sj1ETA    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj1PHI").c_str(),     Jet_LSF_ExkT4_sj1PHI    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj1M").c_str(),     Jet_LSF_ExkT4_sj1M    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj2PT").c_str(),     Jet_LSF_ExkT4_sj2PT    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj2ETA").c_str(),     Jet_LSF_ExkT4_sj2ETA    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj2PHI").c_str(),     Jet_LSF_ExkT4_sj2PHI    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj2M").c_str(),     Jet_LSF_ExkT4_sj2M    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj3PT").c_str(),     Jet_LSF_ExkT4_sj3PT    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj3ETA").c_str(),     Jet_LSF_ExkT4_sj3ETA    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj3PHI").c_str(),     Jet_LSF_ExkT4_sj3PHI    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj3M").c_str(),     Jet_LSF_ExkT4_sj3M    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj4PT").c_str(),     Jet_LSF_ExkT4_sj4PT    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj4ETA").c_str(),     Jet_LSF_ExkT4_sj4ETA    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj4PHI").c_str(),     Jet_LSF_ExkT4_sj4PHI    );
      tree->SetBranchAddress((name+"Jet_LSF_ExkT4_sj4M").c_str(),     Jet_LSF_ExkT4_sj4M    );
      tree->SetBranchAddress((name+"nSubjetsIn").c_str(),       &nSubjetsIn        );
      tree->SetBranchAddress((name+"Jet_LSF_Incl_LSF").c_str(),    Jet_LSF_Incl_LSF     );
      tree->SetBranchAddress((name+"Jet_LSF_Incl_LMD").c_str(),    Jet_LSF_Incl_LMD     );
      tree->SetBranchAddress((name+"Jet_LSF_Incl_sjIndex").c_str(),    Jet_LSF_Incl_sjIndex     );
      tree->SetBranchAddress((name+"Jet_LSF_Incl_nSubjets").c_str(),    Jet_LSF_Incl_nSubjets     );
      tree->SetBranchAddress((name+"Jet_LSF_Incl_sjPT").c_str(),    Jet_LSF_Incl_sjPT     );
      tree->SetBranchAddress((name+"Jet_LSF_Incl_sjETA").c_str(),    Jet_LSF_Incl_sjETA     );
      tree->SetBranchAddress((name+"Jet_LSF_Incl_sjPHI").c_str(),    Jet_LSF_Incl_sjPHI     );
      tree->SetBranchAddress((name+"Jet_LSF_Incl_sjM").c_str(),    Jet_LSF_Incl_sjM     );
    ...
    void ReadFatJetSpecificTree(TTree *tree, std::string name="", bool trackVars=false) {
      ...
      tree->SetBranchAddress((name+"Jet_tau3").c_str(),        Jet_tau3        );
      ...
      tree->SetBranchAddress((name+"Jet_tauAxis3_px").c_str(),  Jet_tauAxis3_px  );
      tree->SetBranchAddress((name+"Jet_tauAxis3_py").c_str(),  Jet_tauAxis3_py  );
      tree->SetBranchAddress((name+"Jet_tauAxis3_pz").c_str(),  Jet_tauAxis3_pz  );
      ...
      tree->SetBranchAddress((name+"Jet_e2_b1").c_str(),        Jet_e2_b1        );
      tree->SetBranchAddress((name+"Jet_e3_b1").c_str(),        Jet_e3_b1        );
      tree->SetBranchAddress((name+"Jet_e3_v1_b1").c_str(),        Jet_e3_v1_b1        );
      tree->SetBranchAddress((name+"Jet_e3_v2_b1").c_str(),        Jet_e3_v2_b1        );
      tree->SetBranchAddress((name+"Jet_e4_v1_b1").c_str(),        Jet_e4_v1_b1        );
      tree->SetBranchAddress((name+"Jet_e4_v2_b1").c_str(),        Jet_e4_v2_b1        );
      tree->SetBranchAddress((name+"Jet_e2_b2").c_str(),        Jet_e2_b2        );
      tree->SetBranchAddress((name+"Jet_e3_b2").c_str(),        Jet_e3_b2        );
      tree->SetBranchAddress((name+"Jet_e3_v1_b2").c_str(),        Jet_e3_v1_b2        );
      tree->SetBranchAddress((name+"Jet_e3_v2_b2").c_str(),        Jet_e3_v2_b2        );
      tree->SetBranchAddress((name+"Jet_e4_v1_b2").c_str(),        Jet_e4_v1_b2        );
      tree->SetBranchAddress((name+"Jet_e4_v2_b2").c_str(),        Jet_e4_v2_b2        );
      /*tree->SetBranchAddress((name+"Jet_e2_sdb1").c_str(),        Jet_e2_sdb1        );
      tree->SetBranchAddress((name+"Jet_e3_sdb1").c_str(),        Jet_e3_sdb1        );
      tree->SetBranchAddress((name+"Jet_e3_v1_sdb1").c_str(),        Jet_e3_v1_sdb1        );
      tree->SetBranchAddress((name+"Jet_e3_v2_sdb1").c_str(),        Jet_e3_v2_sdb1        );
      tree->SetBranchAddress((name+"Jet_e4_v1_sdb1").c_str(),        Jet_e4_v1_sdb1        );
      tree->SetBranchAddress((name+"Jet_e4_v2_sdb1").c_str(),        Jet_e4_v2_sdb1        );
      tree->SetBranchAddress((name+"Jet_e2_sdb2").c_str(),        Jet_e2_sdb2        );
      tree->SetBranchAddress((name+"Jet_e3_sdb2").c_str(),        Jet_e3_sdb2        );
      tree->SetBranchAddress((name+"Jet_e3_v1_sdb2").c_str(),        Jet_e3_v1_sdb2        );
      tree->SetBranchAddress((name+"Jet_e3_v2_sdb2").c_str(),        Jet_e3_v2_sdb2        );
      tree->SetBranchAddress((name+"Jet_e4_v1_sdb2").c_str(),        Jet_e4_v1_sdb2        );
      tree->SetBranchAddress((name+"Jet_e4_v2_sdb2").c_str(),        Jet_e4_v2_sdb2        );
      */
      if (trackVars)
      {
        TBranch* br = (TBranch*)tree->GetListOfBranches()->FindObject(TString((name+"nTrack").c_str()));
