...
TTree *GetChain(TFile *ThisTree, bool ReadLightTracks = false, TString TreeName = "btagana", bool ReadOnlyEventInfo = false) {
  ...
  if (TreeName=="btaganaFatJets") {
    ...
    tchain->SetBranchAddress("FatJetInfo.Jet_LSF_lepPT", Jet_LSF_lepPT);
    tchain->SetBranchAddress("FatJetInfo.Jet_LSF_lepETA", Jet_LSF_lepETA);
    tchain->SetBranchAddress("FatJetInfo.Jet_LSF_lepPHI", Jet_LSF_lepPHI);
    tchain->SetBranchAddress("FatJetInfo.Jet_LSF_lepTYPE", Jet_LSF_lepTYPE);
