...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer16MiniAODv2/BulkGravTohhTohVVhbb_narrow_M-1000_13TeV-madgraph/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/60000/3CBA9954-14BF-E611-B01E-842B2B7682B8.root')
)
...
process.ak4Jets = cms.EDProducer("FastjetJetProducer",
...
process.deepFlavourJetTagsFatPFCHSPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNTagInfosFatPFCHSPFlow")
)


process.deepFlavourJetTagsPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNTagInfosPFlow")
)


process.deepFlavourJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNTagInfosPrunedSubjetsPFCHSPFlow")
)


process.deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNTagInfosSoftDropSubjetsPFCHSPFlow")
)


process.deepNNNegativeTagInfosFatPFCHSPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
    ...
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosFatPFCHSPFlow")
)


process.deepNNNegativeTagInfosPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
    ...
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosPFlow")
)


process.deepNNNegativeTagInfosPrunedSubjetsPFCHSPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
    ...
    fatJets = cms.InputTag("fatPFJetsCHS"),
    groomedFatJets = cms.InputTag("fatPFJetsCHSPruned"),
    jetAlgorithm = cms.string('AntiKt'),
    rParam = cms.double(0.8),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosPrunedSubjetsPFCHSPFlow"),
    useSVClustering = cms.bool(True)
)


process.deepNNNegativeTagInfosSoftDropSubjetsPFCHSPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
    ...
    fatJets = cms.InputTag("fatPFJetsCHS"),
    groomedFatJets = cms.InputTag("fatPFJetsCHSSoftDrop"),
    jetAlgorithm = cms.string('AntiKt'),
    rParam = cms.double(0.8),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosSoftDropSubjetsPFCHSPFlow"),
    useSVClustering = cms.bool(True)
)


process.deepNNPositiveTagInfosFatPFCHSPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
    ...
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosFatPFCHSPFlow")
)


process.deepNNPositiveTagInfosPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
    ...
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosPFlow")
)


process.deepNNPositiveTagInfosPrunedSubjetsPFCHSPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
    ...
    jetAlgorithm = cms.string('AntiKt'),
    rParam = cms.double(0.8),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosPrunedSubjetsPFCHSPFlow"),
    useSVClustering = cms.bool(True)
)


process.deepNNPositiveTagInfosSoftDropSubjetsPFCHSPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
    ...
    jetAlgorithm = cms.string('AntiKt'),
    rParam = cms.double(0.8),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosSoftDropSubjetsPFCHSPFlow"),
    useSVClustering = cms.bool(True)
)


process.deepNNTagInfosFatPFCHSPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
...
process.deepNNTagInfosPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
...
process.deepNNTagInfosPrunedSubjetsPFCHSPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
...
process.deepNNTagInfosSoftDropSubjetsPFCHSPFlow = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
...
process.fatPFJetsCHS = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
...
process.fatPFJetsCHSPruned = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
...
process.fatPFJetsCHSSoftDrop = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    R0 = cms.double(0.8),
...
process.genFatJetsNoNu = cms.EDProducer("FastjetJetProducer",
...
process.genFatJetsNoNuPruned = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(5),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(6.0),
    Rho_EtaMax = cms.double(4.5),
...
process.genFatJetsNoNuSoftDrop = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(5),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(6.0),
    R0 = cms.double(0.8),
...
process.negativeDeepFlavourJetTagsFatPFCHSPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNNegativeTagInfosFatPFCHSPFlow")
)


process.negativeDeepFlavourJetTagsPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNNegativeTagInfosPFlow")
)


process.negativeDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNNegativeTagInfosPrunedSubjetsPFCHSPFlow")
)


process.negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNNegativeTagInfosSoftDropSubjetsPFCHSPFlow")
)


process.negativeSoftPFElectronBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('negativeSoftPFElectronComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)
...
process.negativeSoftPFMuonBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('negativeSoftPFMuonComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"))
)
...
process.packedPatJetsFatPFCHS = cms.EDProducer("JetSubstructurePacker",
    ...
    algoTags = cms.VInputTag(cms.InputTag("selectedPatJetsSoftDropFatPFCHSPacked")),
    distMax = cms.double(0.8),
    fixDaughters = cms.bool(False),
    jetSrc = cms.InputTag("selectedPatJetsFatPFCHSPFlow")
)
...
process.patJetCorrFactorsFatPFCHSPFlow = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
...
process.patJetCorrFactorsPrunedFatPFCHSPFlow = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("fatPFJetsCHSPruned"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)
...
process.patJetCorrFactorsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetCorrFactorsProducer",
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("fatPFJetsCHSPruned","SubJets"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)


process.patJetCorrFactorsSoftDropFatPFCHSPFlow = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("fatPFJetsCHSSoftDrop"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)
...
process.patJetCorrFactorsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetCorrFactorsProducer",
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("fatPFJetsCHSSoftDrop","SubJets"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)


process.patJetCorrFactorsTransientCorrectedPFlow = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L2Relative', 
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("updatedPatJetsPFlow"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)
...
process.patJetFlavourAssociationFatPFCHSPFlow = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartonsPFlow","bHadrons"),
    cHadrons = cms.InputTag("patJetPartonsPFlow","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("fatPFJetsCHS"),
...
process.patJetFlavourAssociationLegacyFatPFCHSPFlow = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyFatPFCHSPFlow")
)
...
process.patJetFlavourAssociationPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetFlavourClustering",
    ...
    cHadrons = cms.InputTag("patJetPartonsPFlow","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    groomedJets = cms.InputTag("fatPFJetsCHSPruned"),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("fatPFJetsCHS"),
    leptons = cms.InputTag("patJetPartonsPFlow","leptons"),
    partons = cms.InputTag("patJetPartonsPFlow","algorithmicPartons"),
    rParam = cms.double(0.8),
    subjets = cms.InputTag("fatPFJetsCHSPruned","SubJets")
)
...
process.patJetFlavourAssociationSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetFlavourClustering",
    ...
    cHadrons = cms.InputTag("patJetPartonsPFlow","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    groomedJets = cms.InputTag("fatPFJetsCHSSoftDrop"),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("fatPFJetsCHS"),
    leptons = cms.InputTag("patJetPartonsPFlow","leptons"),
    partons = cms.InputTag("patJetPartonsPFlow","algorithmicPartons"),
    rParam = cms.double(0.8),
    subjets = cms.InputTag("fatPFJetsCHSSoftDrop","SubJets")
)
...
process.patJetGenJetMatchFatPFCHSPFlow = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("genFatJetsNoNu"),
...
process.patJetGenJetMatchPrunedFatPFCHSPFlow = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("genFatJetsNoNu"),
    maxDeltaR = cms.double(0.4),
    mcPdgId = cms.vint32(),
...
process.patJetGenJetMatchPrunedSubjetsPFCHSPFlow = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("genFatJetsNoNuPruned","SubJets"),
    maxDeltaR = cms.double(0.8),
    mcPdgId = cms.vint32(),
    mcStatus = cms.vint32(),
    resolveAmbiguities = cms.bool(True),
...
process.patJetGenJetMatchSoftDropFatPFCHSPFlow = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("genFatJetsNoNu"),
    maxDeltaR = cms.double(0.4),
    mcPdgId = cms.vint32(),
...
process.patJetGenJetMatchSoftDropSubjetsPFCHSPFlow = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("genFatJetsNoNuSoftDrop","SubJets"),
    maxDeltaR = cms.double(0.8),
    mcPdgId = cms.vint32(),
    mcStatus = cms.vint32(),
    resolveAmbiguities = cms.bool(True),
...
process.patJetPartonAssociationLegacyFatPFCHSPFlow = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("fatPFJetsCHS"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonAssociationLegacyPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("fatPFJetsCHSPruned","SubJets"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonAssociationLegacySoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("fatPFJetsCHSSoftDrop","SubJets"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonMatchFatPFCHSPFlow = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
...
process.patJetPartonMatchPrunedFatPFCHSPFlow = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("prunedGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetPartonMatchSoftDropFatPFCHSPFlow = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("prunedGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJets = cms.EDProducer("PATJetProducer",
    ...
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetBProbabilityBJetTags"), cms.InputTag("pfJetProbabilityBJetTags"), cms.InputTag("pfTrackCountingHighEffBJetTags"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTags"), cms.InputTag("pfSimpleInclusiveSecondaryVertexHighEffBJetTags"), 
        ...
        cms.InputTag("pfCombinedCvsLJetTags"), cms.InputTag("pfCombinedCvsBJetTags"), cms.InputTag("deepFlavourJetTags","probb"), cms.InputTag("deepFlavourJetTags","probc"), cms.InputTag("deepFlavourJetTags","probudsg"), 
        cms.InputTag("deepFlavourJetTags","probbb"), cms.InputTag("deepFlavourJetTags","probcc")),
    efficiencies = cms.PSet(
...
process.patJetsFatPFCHSPFlow = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationFatPFCHSPFlow"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyFatPFCHSPFlow"),
    ...
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetBProbabilityBJetTagsFatPFCHSPFlow"), cms.InputTag("pfJetProbabilityBJetTagsFatPFCHSPFlow"), cms.InputTag("pfPositiveOnlyJetBProbabilityBJetTagsFatPFCHSPFlow"), cms.InputTag("pfPositiveOnlyJetProbabilityBJetTagsFatPFCHSPFlow"), cms.InputTag("pfNegativeOnlyJetBProbabilityBJetTagsFatPFCHSPFlow"), 
        cms.InputTag("pfNegativeOnlyJetProbabilityBJetTagsFatPFCHSPFlow"), cms.InputTag("pfTrackCountingHighPurBJetTagsFatPFCHSPFlow"), cms.InputTag("pfTrackCountingHighEffBJetTagsFatPFCHSPFlow"), cms.InputTag("pfNegativeTrackCountingHighPurBJetTagsFatPFCHSPFlow"), cms.InputTag("pfNegativeTrackCountingHighEffBJetTagsFatPFCHSPFlow"), 
        cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsFatPFCHSPFlow"), cms.InputTag("pfSimpleSecondaryVertexHighPurBJetTagsFatPFCHSPFlow"), cms.InputTag("pfNegativeSimpleSecondaryVertexHighEffBJetTagsFatPFCHSPFlow"), cms.InputTag("pfNegativeSimpleSecondaryVertexHighPurBJetTagsFatPFCHSPFlow"), cms.InputTag("pfCombinedSecondaryVertexV2BJetTagsFatPFCHSPFlow"), 
        cms.InputTag("pfPositiveCombinedSecondaryVertexV2BJetTagsFatPFCHSPFlow"), cms.InputTag("pfNegativeCombinedSecondaryVertexV2BJetTagsFatPFCHSPFlow"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsFatPFCHSPFlow"), cms.InputTag("pfPositiveCombinedInclusiveSecondaryVertexV2BJetTagsFatPFCHSPFlow"), cms.InputTag("pfNegativeCombinedInclusiveSecondaryVertexV2BJetTagsFatPFCHSPFlow"), 
        cms.InputTag("softPFMuonBJetTagsFatPFCHSPFlow"), cms.InputTag("positiveSoftPFMuonBJetTagsFatPFCHSPFlow"), cms.InputTag("negativeSoftPFMuonBJetTagsFatPFCHSPFlow"), cms.InputTag("softPFElectronBJetTagsFatPFCHSPFlow"), cms.InputTag("positiveSoftPFElectronBJetTagsFatPFCHSPFlow"), 
        cms.InputTag("negativeSoftPFElectronBJetTagsFatPFCHSPFlow"), cms.InputTag("pfCombinedMVAV2BJetTagsFatPFCHSPFlow"), cms.InputTag("pfNegativeCombinedMVAV2BJetTagsFatPFCHSPFlow"), cms.InputTag("pfPositiveCombinedMVAV2BJetTagsFatPFCHSPFlow"), cms.InputTag("pfCombinedCvsBJetTagsFatPFCHSPFlow"), 
        cms.InputTag("pfNegativeCombinedCvsBJetTagsFatPFCHSPFlow"), cms.InputTag("pfPositiveCombinedCvsBJetTagsFatPFCHSPFlow"), cms.InputTag("pfCombinedCvsLJetTagsFatPFCHSPFlow"), cms.InputTag("pfNegativeCombinedCvsLJetTagsFatPFCHSPFlow"), cms.InputTag("pfPositiveCombinedCvsLJetTagsFatPFCHSPFlow"), 
        cms.InputTag("deepFlavourJetTagsFatPFCHSPFlow","probudsg"), cms.InputTag("deepFlavourJetTagsFatPFCHSPFlow","probb"), cms.InputTag("deepFlavourJetTagsFatPFCHSPFlow","probc"), cms.InputTag("deepFlavourJetTagsFatPFCHSPFlow","probbb"), cms.InputTag("deepFlavourJetTagsFatPFCHSPFlow","probcc"), 
        cms.InputTag("negativeDeepFlavourJetTagsFatPFCHSPFlow","probudsg"), cms.InputTag("negativeDeepFlavourJetTagsFatPFCHSPFlow","probb"), cms.InputTag("negativeDeepFlavourJetTagsFatPFCHSPFlow","probc"), cms.InputTag("negativeDeepFlavourJetTagsFatPFCHSPFlow","probbb"), cms.InputTag("negativeDeepFlavourJetTagsFatPFCHSPFlow","probcc"), 
        cms.InputTag("positiveDeepFlavourJetTagsFatPFCHSPFlow","probudsg"), cms.InputTag("positiveDeepFlavourJetTagsFatPFCHSPFlow","probb"), cms.InputTag("positiveDeepFlavourJetTagsFatPFCHSPFlow","probc"), cms.InputTag("positiveDeepFlavourJetTagsFatPFCHSPFlow","probbb"), cms.InputTag("positiveDeepFlavourJetTagsFatPFCHSPFlow","probcc"), 
        cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsFatPFCHSPFlow")),
    efficiencies = cms.PSet(
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchFatPFCHSPFlow"),
    genPartonMatch = cms.InputTag("patJetPartonMatchFatPFCHSPFlow"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsFatPFCHSPFlow")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("fatPFJetsCHS"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(

    ),
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfSecondaryVertexTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosFatPFCHSPFlow"), cms.InputTag("pfSecondaryVertexNegativeTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosFatPFCHSPFlow"), 
        cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosFatPFCHSPFlow"), cms.InputTag("pfImpactParameterAK8TagInfosFatPFCHSPFlow"), 
        cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosFatPFCHSPFlow"), cms.InputTag("pfBoostedDoubleSVAK8TagInfosFatPFCHSPFlow"), cms.InputTag("deepNNTagInfosFatPFCHSPFlow"), cms.InputTag("deepNNNegativeTagInfosFatPFCHSPFlow"), cms.InputTag("deepNNPositiveTagInfosFatPFCHSPFlow")),
...
process.patJetsPrunedFatPFCHSPFlow = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociation"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacy"),
    addAssociatedTracks = cms.bool(False),
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchPrunedFatPFCHSPFlow"),
    genPartonMatch = cms.InputTag("patJetPartonMatchPrunedFatPFCHSPFlow"),
    getJetMCFlavour = cms.bool(False),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsPrunedFatPFCHSPFlow")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("fatPFJetsCHSPruned"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(
...
process.patJetsPrunedSubjetsPFCHSPFlow = cms.EDProducer("PATJetProducer",
    ...
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetBProbabilityBJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfJetProbabilityBJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveOnlyJetBProbabilityBJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveOnlyJetProbabilityBJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeOnlyJetBProbabilityBJetTagsPrunedSubjetsPFCHSPFlow"), 
        ...
        cms.InputTag("negativeSoftPFElectronBJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfCombinedMVAV2BJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeCombinedMVAV2BJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveCombinedMVAV2BJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfCombinedCvsBJetTagsPrunedSubjetsPFCHSPFlow"), 
        cms.InputTag("pfNegativeCombinedCvsBJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveCombinedCvsBJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfCombinedCvsLJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeCombinedCvsLJetTagsPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveCombinedCvsLJetTagsPrunedSubjetsPFCHSPFlow"), 
        cms.InputTag("deepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probudsg"), cms.InputTag("deepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probb"), cms.InputTag("deepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probc"), cms.InputTag("deepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probbb"), cms.InputTag("deepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probcc"), 
        cms.InputTag("negativeDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probudsg"), cms.InputTag("negativeDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probb"), cms.InputTag("negativeDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probc"), cms.InputTag("negativeDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probbb"), cms.InputTag("negativeDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probcc"), 
        cms.InputTag("positiveDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probudsg"), cms.InputTag("positiveDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probb"), cms.InputTag("positiveDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probc"), cms.InputTag("positiveDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probbb"), cms.InputTag("positiveDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow","probcc")),
    efficiencies = cms.PSet(
    ...
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("fatPFJetsCHSPruned","SubJets"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(

    ),
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfSecondaryVertexTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfSecondaryVertexNegativeTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosPrunedSubjetsPFCHSPFlow"), 
        cms.InputTag("softPFMuonsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("deepNNTagInfosPrunedSubjetsPFCHSPFlow"), 
        cms.InputTag("deepNNNegativeTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("deepNNPositiveTagInfosPrunedSubjetsPFCHSPFlow")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.patJetsSoftDropFatPFCHSPFlow = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociation"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacy"),
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchSoftDropFatPFCHSPFlow"),
    genPartonMatch = cms.InputTag("patJetPartonMatchSoftDropFatPFCHSPFlow"),
    getJetMCFlavour = cms.bool(False),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsSoftDropFatPFCHSPFlow")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("fatPFJetsCHSSoftDrop"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(
...
process.patJetsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("PATJetProducer",
    ...
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetBProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfJetProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveOnlyJetBProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveOnlyJetProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeOnlyJetBProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), 
        ...
        cms.InputTag("negativeSoftPFElectronBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfCombinedMVAV2BJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeCombinedMVAV2BJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveCombinedMVAV2BJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfCombinedCvsBJetTagsSoftDropSubjetsPFCHSPFlow"), 
        cms.InputTag("pfNegativeCombinedCvsBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveCombinedCvsBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfCombinedCvsLJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeCombinedCvsLJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveCombinedCvsLJetTagsSoftDropSubjetsPFCHSPFlow"), 
        cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probudsg"), cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probb"), cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probc"), cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probbb"), cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probcc"), 
        cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probudsg"), cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probb"), cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probc"), cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probbb"), cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probcc"), 
        cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probudsg"), cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probb"), cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probc"), cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probbb"), cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probcc")),
    efficiencies = cms.PSet(
    ...
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("fatPFJetsCHSSoftDrop","SubJets"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(

    ),
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfSecondaryVertexTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfSecondaryVertexNegativeTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosSoftDropSubjetsPFCHSPFlow"), 
        cms.InputTag("softPFMuonsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("deepNNTagInfosSoftDropSubjetsPFCHSPFlow"), 
        cms.InputTag("deepNNNegativeTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("deepNNPositiveTagInfosSoftDropSubjetsPFCHSPFlow")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.pfBoostedDoubleSVAK8TagInfosFatPFCHSPFlow = cms.EDProducer("BoostedDoubleSVProducer",
    R0 = cms.double(0.8),
    beta = cms.double(1.0),
    maxSVDeltaRToJet = cms.double(0.7),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosFatPFCHSPFlow"),
    trackPairV0Filter = cms.PSet(
        k0sMassWindow = cms.double(0.03)
    ),
    trackSelection = cms.PSet(
...
process.pfBoostedDoubleSecondaryVertexAK8BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateBoostedDoubleSecondaryVertexAK8Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfBoostedDoubleSVAK8TagInfosFatPFCHSPFlow"))
)
...
process.pfCombinedCvsBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosFatPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)


process.pfCombinedCvsBJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosPrunedSubjetsPFCHSPFlow"))
)


process.pfCombinedCvsBJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosSoftDropSubjetsPFCHSPFlow"))
)


process.pfCombinedCvsLJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosFatPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)


process.pfCombinedCvsLJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosPrunedSubjetsPFCHSPFlow"))
)


process.pfCombinedCvsLJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosSoftDropSubjetsPFCHSPFlow"))
)


process.pfCombinedInclusiveSecondaryVertexV2BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedSecondaryVertexV2ComputerFat'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosFatPFCHSPFlow"))
)
...
process.pfCombinedMVAV2BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfSecondaryVertexTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosFatPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)


process.pfCombinedMVAV2BJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
...
process.pfCombinedMVAV2BJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
...
process.pfCombinedSecondaryVertexV2BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfSecondaryVertexTagInfosFatPFCHSPFlow"))
)
...
process.pfImpactParameterAK8TagInfosFatPFCHSPFlow = cms.EDProducer("CandIPProducer",
...
process.pfImpactParameterTagInfosFatPFCHSPFlow = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
...
process.pfImpactParameterTagInfosPFlow = cms.EDProducer("CandIPProducer",
    ...
    jetDirectionUsingGhostTrack = cms.bool(False),
    jetDirectionUsingTracks = cms.bool(False),
    jets = cms.InputTag("updatedPatJetsPFlow"),
    maxDeltaR = cms.double(0.4),
    maximumChiSquared = cms.double(5.0),
    maximumLongitudinalImpactParameter = cms.double(17.0),
    maximumTransverseImpactParameter = cms.double(0.2),
...
process.pfInclusiveSecondaryVertexFinderAK8TagInfosFatPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.8),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterAK8TagInfosFatPFCHSPFlow"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderCvsLTagInfosFatPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVerticesCvsL"),
    extSVDeltaRToJet = cms.double(0.3),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderCvsLTagInfosPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVerticesCvsL"),
    extSVDeltaRToJet = cms.double(0.3),
...
process.pfInclusiveSecondaryVertexFinderCvsLTagInfosPrunedSubjetsPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVerticesCvsL"),
    extSVDeltaRToJet = cms.double(0.3),
...
process.pfInclusiveSecondaryVertexFinderCvsLTagInfosSoftDropSubjetsPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVerticesCvsL"),
    extSVDeltaRToJet = cms.double(0.3),
...
process.pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosFatPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVerticesCvsL"),
    extSVDeltaRToJet = cms.double(-0.3),
...
process.pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVerticesCvsL"),
    extSVDeltaRToJet = cms.double(-0.3),
...
process.pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosPrunedSubjetsPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVerticesCvsL"),
    extSVDeltaRToJet = cms.double(-0.3),
...
process.pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosSoftDropSubjetsPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVerticesCvsL"),
    extSVDeltaRToJet = cms.double(-0.3),
...
process.pfInclusiveSecondaryVertexFinderNegativeTagInfosFatPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(-0.3),
...
process.pfInclusiveSecondaryVertexFinderTagInfosFatPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.8),
...
process.pfJetBProbabilityBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetBProbabilityComputerFat'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"))
)
...
process.pfJetProbabilityBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfNegativeCombinedCvsBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsNegativeComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosFatPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)


process.pfNegativeCombinedCvsBJetTagsPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsNegativeComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosPFlow"), cms.InputTag("softPFMuonsTagInfosPFlow"), cms.InputTag("softPFElectronsTagInfosPFlow"))
)


process.pfNegativeCombinedCvsBJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsNegativeComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosPrunedSubjetsPFCHSPFlow"))
)


process.pfNegativeCombinedCvsBJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsNegativeComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosSoftDropSubjetsPFCHSPFlow"))
)


process.pfNegativeCombinedCvsLJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsNegativeComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosFatPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)


process.pfNegativeCombinedCvsLJetTagsPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsNegativeComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosPFlow"), cms.InputTag("softPFMuonsTagInfosPFlow"), cms.InputTag("softPFElectronsTagInfosPFlow"))
)


process.pfNegativeCombinedCvsLJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsNegativeComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosPrunedSubjetsPFCHSPFlow"))
)


process.pfNegativeCombinedCvsLJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsNegativeComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosSoftDropSubjetsPFCHSPFlow"))
)


process.pfNegativeCombinedInclusiveSecondaryVertexV2BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateNegativeCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosFatPFCHSPFlow"))
)
...
process.pfNegativeCombinedMVAV2BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateNegativeCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfSecondaryVertexNegativeTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosFatPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)


process.pfNegativeCombinedMVAV2BJetTagsPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateNegativeCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPFlow"), cms.InputTag("pfSecondaryVertexNegativeTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosPFlow"), cms.InputTag("softPFMuonsTagInfosPFlow"), cms.InputTag("softPFElectronsTagInfosPFlow"))
)


process.pfNegativeCombinedMVAV2BJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateNegativeCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfSecondaryVertexNegativeTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosPrunedSubjetsPFCHSPFlow"))
)


process.pfNegativeCombinedMVAV2BJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateNegativeCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfSecondaryVertexNegativeTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosSoftDropSubjetsPFCHSPFlow"))
)


process.pfNegativeCombinedSecondaryVertexV2BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateNegativeCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfSecondaryVertexNegativeTagInfosFatPFCHSPFlow"))
)
...
process.pfNegativeOnlyJetBProbabilityBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfNegativeOnlyJetProbabilityBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfNegativeSimpleSecondaryVertexHighEffBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexNegativeTagInfosFatPFCHSPFlow"))
)
...
process.pfNegativeSimpleSecondaryVertexHighPurBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfNegativeTrackCountingHighEffBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfNegativeTrackCountingHighPurBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfPositiveCombinedCvsBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsPositiveComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosFatPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)


process.pfPositiveCombinedCvsBJetTagsPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsPositiveComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosPFlow"), cms.InputTag("softPFMuonsTagInfosPFlow"), cms.InputTag("softPFElectronsTagInfosPFlow"))
)


process.pfPositiveCombinedCvsBJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsPositiveComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosPrunedSubjetsPFCHSPFlow"))
)


process.pfPositiveCombinedCvsBJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsPositiveComputerCvsB'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosSoftDropSubjetsPFCHSPFlow"))
)


process.pfPositiveCombinedCvsLJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsPositiveComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosFatPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)


process.pfPositiveCombinedCvsLJetTagsPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsPositiveComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosPFlow"), cms.InputTag("softPFMuonsTagInfosPFlow"), cms.InputTag("softPFElectronsTagInfosPFlow"))
)


process.pfPositiveCombinedCvsLJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsPositiveComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosPrunedSubjetsPFCHSPFlow"))
)


process.pfPositiveCombinedCvsLJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('charmTagsPositiveComputerCvsL'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosSoftDropSubjetsPFCHSPFlow"))
)


process.pfPositiveCombinedInclusiveSecondaryVertexV2BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfPositiveCombinedMVAV2BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidatePositiveCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfSecondaryVertexTagInfosFatPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosFatPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosFatPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosFatPFCHSPFlow"))
)


process.pfPositiveCombinedMVAV2BJetTagsPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidatePositiveCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPFlow"), cms.InputTag("pfSecondaryVertexTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosPFlow"), cms.InputTag("softPFMuonsTagInfosPFlow"), cms.InputTag("softPFElectronsTagInfosPFlow"))
)


process.pfPositiveCombinedMVAV2BJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidatePositiveCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfSecondaryVertexTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosPrunedSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosPrunedSubjetsPFCHSPFlow"))
)


process.pfPositiveCombinedMVAV2BJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidatePositiveCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfSecondaryVertexTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonsTagInfosSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronsTagInfosSoftDropSubjetsPFCHSPFlow"))
)


process.pfPositiveCombinedSecondaryVertexV2BJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidatePositiveCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosFatPFCHSPFlow"), cms.InputTag("pfSecondaryVertexTagInfosFatPFCHSPFlow"))
)
...
process.pfPositiveOnlyJetBProbabilityBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfPositiveOnlyJetProbabilityBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfSecondaryVertexNegativeTagInfosFatPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
...
process.pfSecondaryVertexTagInfosFatPFCHSPFlow = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("secondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
...
process.pfSimpleSecondaryVertexHighEffBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosFatPFCHSPFlow"))
)
...
process.pfSimpleSecondaryVertexHighPurBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex3TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosFatPFCHSPFlow"))
)
...
process.pfTrackCountingHighEffBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.pfTrackCountingHighPurBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.positiveDeepFlavourJetTagsFatPFCHSPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNPositiveTagInfosFatPFCHSPFlow")
)


process.positiveDeepFlavourJetTagsPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNPositiveTagInfosPFlow")
)


process.positiveDeepFlavourJetTagsPrunedSubjetsPFCHSPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNPositiveTagInfosPrunedSubjetsPFCHSPFlow")
)


process.positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("DeepFlavourJetTagsProducer",
    NNConfig = cms.FileInPath('RecoBTag/DeepFlavour/data/DeepFlavourNoSL.json'),
    src = cms.InputTag("deepNNPositiveTagInfosSoftDropSubjetsPFCHSPFlow")
)


process.positiveSoftPFElectronBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.positiveSoftPFMuonBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.prunedGenParticlesBoost = cms.EDProducer("GenParticlePruner",
    select = cms.vstring('drop  *  ', 
        'keep ( status = 3 || (status>=21 && status<=29) ) && pt > 0', 
...
process.selectedPatJetsPrunedFatPFCHSPacked = cms.EDProducer("BoostedJetMerger",
    jetSrc = cms.InputTag("selectedPatJetsPrunedFatPFCHSPFlow"),
...
process.selectedPatJetsSoftDropFatPFCHSPacked = cms.EDProducer("BoostedJetMerger",
    jetSrc = cms.InputTag("selectedPatJetsSoftDropFatPFCHSPFlow"),
...
process.softPFElectronBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.softPFElectronsTagInfosFatPFCHSPFlow = cms.EDProducer("SoftPFElectronTagInfoProducer",
...
process.softPFMuonBJetTagsFatPFCHSPFlow = cms.EDProducer("JetTagProducer",
...
process.softPFMuonsTagInfosFatPFCHSPFlow = cms.EDProducer("SoftPFMuonTagInfoProducer",
...
process.updatedPatJetsPFlow = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(False),
...
process.updatedPatJetsTransientCorrectedPFlow = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetBProbabilityBJetTagsPFlow"), cms.InputTag("pfJetProbabilityBJetTagsPFlow"), cms.InputTag("pfPositiveOnlyJetBProbabilityBJetTagsPFlow"), cms.InputTag("pfPositiveOnlyJetProbabilityBJetTagsPFlow"), cms.InputTag("pfNegativeOnlyJetBProbabilityBJetTagsPFlow"), 
        cms.InputTag("pfNegativeOnlyJetProbabilityBJetTagsPFlow"), cms.InputTag("pfTrackCountingHighPurBJetTagsPFlow"), cms.InputTag("pfNegativeTrackCountingHighPurBJetTagsPFlow"), cms.InputTag("pfNegativeTrackCountingHighEffBJetTagsPFlow"), cms.InputTag("pfSimpleSecondaryVertexHighPurBJetTagsPFlow"), 
        cms.InputTag("pfNegativeSimpleSecondaryVertexHighEffBJetTagsPFlow"), cms.InputTag("pfNegativeSimpleSecondaryVertexHighPurBJetTagsPFlow"), cms.InputTag("pfPositiveCombinedSecondaryVertexV2BJetTagsPFlow"), cms.InputTag("pfNegativeCombinedSecondaryVertexV2BJetTagsPFlow"), cms.InputTag("pfPositiveCombinedInclusiveSecondaryVertexV2BJetTagsPFlow"), 
        cms.InputTag("pfNegativeCombinedInclusiveSecondaryVertexV2BJetTagsPFlow"), cms.InputTag("positiveSoftPFMuonBJetTagsPFlow"), cms.InputTag("negativeSoftPFMuonBJetTagsPFlow"), cms.InputTag("positiveSoftPFElectronBJetTagsPFlow"), cms.InputTag("negativeSoftPFElectronBJetTagsPFlow"), 
        cms.InputTag("pfNegativeCombinedMVAV2BJetTagsPFlow"), cms.InputTag("pfPositiveCombinedMVAV2BJetTagsPFlow"), cms.InputTag("pfNegativeCombinedCvsBJetTagsPFlow"), cms.InputTag("pfPositiveCombinedCvsBJetTagsPFlow"), cms.InputTag("pfNegativeCombinedCvsLJetTagsPFlow"), 
        cms.InputTag("pfPositiveCombinedCvsLJetTagsPFlow"), cms.InputTag("deepFlavourJetTagsPFlow","probudsg"), cms.InputTag("deepFlavourJetTagsPFlow","probb"), cms.InputTag("deepFlavourJetTagsPFlow","probc"), cms.InputTag("deepFlavourJetTagsPFlow","probbb"), 
        cms.InputTag("deepFlavourJetTagsPFlow","probcc"), cms.InputTag("negativeDeepFlavourJetTagsPFlow","probudsg"), cms.InputTag("negativeDeepFlavourJetTagsPFlow","probb"), cms.InputTag("negativeDeepFlavourJetTagsPFlow","probc"), cms.InputTag("negativeDeepFlavourJetTagsPFlow","probbb"), 
        cms.InputTag("negativeDeepFlavourJetTagsPFlow","probcc"), cms.InputTag("positiveDeepFlavourJetTagsPFlow","probudsg"), cms.InputTag("positiveDeepFlavourJetTagsPFlow","probb"), cms.InputTag("positiveDeepFlavourJetTagsPFlow","probc"), cms.InputTag("positiveDeepFlavourJetTagsPFlow","probbb"), 
        cms.InputTag("positiveDeepFlavourJetTagsPFlow","probcc")),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsTransientCorrectedPFlow")),
    jetSource = cms.InputTag("updatedPatJetsPFlow"),
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosPFlow"), cms.InputTag("pfSecondaryVertexTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosPFlow"), cms.InputTag("pfSecondaryVertexNegativeTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeTagInfosPFlow"), 
        cms.InputTag("softPFMuonsTagInfosPFlow"), cms.InputTag("softPFElectronsTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderCvsLTagInfosPFlow"), cms.InputTag("pfInclusiveSecondaryVertexFinderNegativeCvsLTagInfosPFlow"), cms.InputTag("deepNNTagInfosPFlow"), 
        cms.InputTag("deepNNNegativeTagInfosPFlow"), cms.InputTag("deepNNPositiveTagInfosPFlow")),
    userData = cms.PSet(
        userCands = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.selectedPatJetsFatPFCHSPFlow = cms.EDFilter("PATJetSelector",
    cut = cms.string('pt > 200.000000 && abs(eta) < 2.500000'),
    src = cms.InputTag("patJetsFatPFCHSPFlow")
)


process.selectedPatJetsPrunedFatPFCHSPFlow = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("patJetsPrunedFatPFCHSPFlow")
)
...
process.selectedPatJetsSoftDropFatPFCHSPFlow = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("patJetsSoftDropFatPFCHSPFlow")
)
...
process.selectedUpdatedPatJetsPFlow = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("updatedPatJetsTransientCorrectedPFlow")
)
...
process.btagana = cms.EDAnalyzer("BTagAnalyzer",
    ...
    Jets = cms.InputTag("selectedUpdatedPatJetsPFlow"),
    ...
    TriggerPathNames = cms.vstring('HLT_PFJet40_v*', 
        'HLT_PFJet60_v*', 
        'HLT_PFJet80_v*', 
        'HLT_PFJet140_v*', 
        'HLT_PFJet200_v*', 
    ...
    primaryVertexColl = cms.InputTag("offlineSlimmedPrimaryVertices"),
...
process.btaganaFatJets = cms.EDAnalyzer("BTagAnalyzer",
    ...
    CvsLNegCJetTags = cms.string('pfNegativeCombinedCvsLJetTags'),
    CvsLPosCJetTags = cms.string('pfPositiveCombinedCvsLJetTags'),
    Jets = cms.InputTag("packedPatJetsFatPFCHS"),
    MaxEta = cms.double(2.5),
    MinPt = cms.double(20.0),
    PFJet80TriggerPathNames = cms.vstring('HLT_PFJet80_v*'),
    R0 = cms.double(0.8),
    SubJetLabels = cms.vstring('SoftDrop'),
    SubJets = cms.VInputTag(cms.InputTag("selectedPatJetsSoftDropFatPFCHSPacked","SubJets")),
    TTbarTriggerPathNames = cms.vstring('HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v*', 
        'HLT_Mu17_Mu8_v*', 
        'HLT_Mu17_TkMu8_v*', 
        'HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v*', 
...
process.analyzerSeq = cms.Sequence(process.btaganaFatJets)
...
process.filtSeq = cms.Sequence(process.primaryVertexFilter)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('JetTree_mc_FatJets_Subjets.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    toGet = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('JPcalib_MC80X_v3')
    ))
)
...
process.jec = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('sqlite_fip:RecoBTag/PerformanceMeasurements/data/Summer16_23Sep2016V3_MC.db'),
    toGet = cms.VPSet(cms.PSet(
        label = cms.untracked.string('AK4PF'),
        record = cms.string('JetCorrectionsRecord'),
        tag = cms.string('JetCorrectorParametersCollection_Summer16_23Sep2016V3_MC_AK4PF')
    ), 
        cms.PSet(
        ...
        cms.PSet(
            ...
            record = cms.string('JetCorrectionsRecord'),
            tag = cms.string('JetCorrectorParametersCollection_Summer16_23Sep2016V3_MC_AK4PFPuppi')
        ), 
        cms.PSet(
            label = cms.untracked.string('AK8PF'),
            record = cms.string('JetCorrectionsRecord'),
            tag = cms.string('JetCorrectorParametersCollection_Summer16_23Sep2016V3_MC_AK8PF')
        ), 
        cms.PSet(
        ...
        cms.PSet(
            ...
            record = cms.string('JetCorrectionsRecord'),
            tag = cms.string('JetCorrectorParametersCollection_Summer16_23Sep2016V3_MC_AK8PFPuppi')
        ))
)
