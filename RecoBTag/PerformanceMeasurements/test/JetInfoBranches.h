...
class JetInfoBranches {
  ...
  public :
    ...
    float Jet_LSF_LSF[nMaxJets_];
    float Jet_LSF_LMD[nMaxJets_];
    ...
    void RegisterTree(TTree *tree, std::string name="") {
      ...
      tree->Branch((name+"Jet_LSF_LSF").c_str(),     Jet_LSF_LSF     ,(name+"Jet_LSF_LSF["+name+"nJet]/F").c_str()            );
      tree->Branch((name+"Jet_LSF_LMD").c_str(),     Jet_LSF_LMD     ,(name+"Jet_LSF_LMD["+name+"nJet]/F").c_str()            );
    ...
    void ReadTree(TTree *tree, std::string name="") {
      ...
      tree->SetBranchAddress((name+"Jet_LSF_LSF").c_str(),     Jet_LSF_LSF    );
      tree->SetBranchAddress((name+"Jet_LSF_LMD").c_str(),     Jet_LSF_LMD    );
