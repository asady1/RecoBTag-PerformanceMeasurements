...
public :
   ...
   Float_t         Jet_LSF_lepPT[50];
   Float_t         Jet_LSF_lepETA[50];
   Float_t         Jet_LSF_lepPHI[50];
   Int_t           Jet_LSF_lepTYPE[50];
   Int_t           nMuon;
   ...
   TBranch        *b_Jet_LSF_lepPT;
   TBranch        *b_Jet_LSF_lepETA;
   TBranch        *b_Jet_LSF_lepPHI;
   TBranch        *b_Jet_LSF_lepTYPE;
   TBranch        *b_nMuon;   //!
...
void JetTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Jet_LSF_lepPT", Jet_LSF_lepPT, &b_Jet_LSF_lepPT);
   fChain->SetBranchAddress("Jet_LSF_lepETA", Jet_LSF_lepETA, &b_Jet_LSF_lepETA);
   fChain->SetBranchAddress("Jet_LSF_lepPHI", Jet_LSF_lepPHI, &b_Jet_LSF_lepPHI);
   fChain->SetBranchAddress("Jet_LSF_lepTYPE", Jet_LSF_lepTYPE, &b_Jet_LSF_lepTYPE);
