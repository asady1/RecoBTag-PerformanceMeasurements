...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer16MiniAODv2/QCD_Pt_300to470_TuneCUETP8M1_13TeV_pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/80000/008761B6-F5B4-E611-AC01-0CC47A706D26.root')
)
...
process.patJetCorrFactorsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetCorrFactorsProducer",
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("slimmedJetsAK8PFCHSSoftDropPacked","SubJets"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)


process.patJetCorrFactorsTransientCorrectedFatPFCHSPFlow = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("updatedPatJetsFatPFCHSPFlow"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)
...
process.patJetCorrFactorsTransientCorrectedSoftDropSubjetsPFCHSPFlow = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("updatedPatJetsSoftDropSubjetsPFCHSPFlow"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)
...
process.pfImpactParameterAK8TagInfosFatPFCHSPFlow = cms.EDProducer("CandIPProducer",
    ...
    jets = cms.InputTag("updatedPatJetsFatPFCHSPFlow"),
...
process.pfImpactParameterTagInfosSoftDropSubjetsPFCHSPFlow = cms.EDProducer("CandIPProducer",
    ...
    jetDirectionUsingGhostTrack = cms.bool(False),
    jetDirectionUsingTracks = cms.bool(False),
    jets = cms.InputTag("updatedPatJetsSoftDropSubjetsPFCHSPFlow"),
    maxDeltaR = cms.double(0.4),
    maximumChiSquared = cms.double(5.0),
    maximumLongitudinalImpactParameter = cms.double(17.0),
    maximumTransverseImpactParameter = cms.double(0.2),
...
process.updatedPatJetsFatPFCHSPFlow = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(False),
...
process.updatedPatJetsSoftDropSubjetsPFCHSPFlow = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(False),
...
process.updatedPatJetsTransientCorrectedFatPFCHSPFlow = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    ...
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsTransientCorrectedFatPFCHSPFlow")),
    jetSource = cms.InputTag("updatedPatJetsFatPFCHSPFlow"),
...
process.updatedPatJetsTransientCorrectedSoftDropSubjetsPFCHSPFlow = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetBProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfJetProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveOnlyJetBProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveOnlyJetProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeOnlyJetBProbabilityBJetTagsSoftDropSubjetsPFCHSPFlow"), 
        ...
        cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfSimpleSecondaryVertexHighPurBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeSimpleSecondaryVertexHighEffBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeSimpleSecondaryVertexHighPurBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveCombinedSecondaryVertexV2BJetTagsSoftDropSubjetsPFCHSPFlow"), 
        cms.InputTag("pfNegativeCombinedSecondaryVertexV2BJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveCombinedInclusiveSecondaryVertexV2BJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeCombinedInclusiveSecondaryVertexV2BJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFMuonBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("positiveSoftPFMuonBJetTagsSoftDropSubjetsPFCHSPFlow"), 
        cms.InputTag("negativeSoftPFMuonBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("softPFElectronBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("positiveSoftPFElectronBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("negativeSoftPFElectronBJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfCombinedMVAV2BJetTagsSoftDropSubjetsPFCHSPFlow"), 
        ...
        cms.InputTag("pfCombinedCvsLJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfNegativeCombinedCvsLJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("pfPositiveCombinedCvsLJetTagsSoftDropSubjetsPFCHSPFlow"), cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probudsg"), cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probb"), 
        cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probc"), cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probbb"), cms.InputTag("deepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probcc"), cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probudsg"), cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probb"), 
        cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probc"), cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probbb"), cms.InputTag("negativeDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probcc"), cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probudsg"), cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probb"), 
        cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probc"), cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probbb"), cms.InputTag("positiveDeepFlavourJetTagsSoftDropSubjetsPFCHSPFlow","probcc")),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsTransientCorrectedSoftDropSubjetsPFCHSPFlow")),
    jetSource = cms.InputTag("updatedPatJetsSoftDropSubjetsPFCHSPFlow"),
...
process.selectedUpdatedPatJetsFatPFCHSPFlow = cms.EDFilter("PATJetSelector",
    cut = cms.string('pt > 200.000000 && abs(eta) < 2.500000'),
    src = cms.InputTag("updatedPatJetsTransientCorrectedFatPFCHSPFlow")
)
...
process.selectedUpdatedPatJetsSoftDropSubjetsPFCHSPFlow = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("updatedPatJetsTransientCorrectedSoftDropSubjetsPFCHSPFlow")
)
...
process.btaganaFatJets = cms.EDAnalyzer("BTagAnalyzer",
    ...
    CvsLNegCJetTags = cms.string('pfNegativeCombinedCvsLJetTags'),
    CvsLPosCJetTags = cms.string('pfPositiveCombinedCvsLJetTags'),
    Jets = cms.InputTag("selectedUpdatedPatJetsFatPFCHSPFlow"),
    MaxEta = cms.double(2.5),
    MinPt = cms.double(20.0),
    PFJet80TriggerPathNames = cms.vstring('HLT_PFJet80_v*'),
    R0 = cms.double(0.8),
    SubJetLabels = cms.vstring('SoftDrop'),
    SubJets = cms.VInputTag(cms.InputTag("selectedUpdatedPatJetsSoftDropSubjetsPFCHSPFlow")),
    TTbarTriggerPathNames = cms.vstring('HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v*', 
        'HLT_Mu17_Mu8_v*', 
        'HLT_Mu17_TkMu8_v*', 
        'HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v*', 
