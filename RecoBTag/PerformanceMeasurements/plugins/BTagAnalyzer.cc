...
private:
  ...
  void recalcNsubjettiness(const pat::Jet & jet, float & tau1, float & tau2, float & tau3, std::vector<fastjet::PseudoJet> & currentAxes) const;
  ...
  deltaRSubJets_(iConfig.getParameter<double>("deltaRSubJets"))
{
  ...
  if ( runFatJets_ )
  {
    ...
    // initialize ECF manager
    ECF_ = new EnergyCorrelations();
  }
					  ...
					  const edm::Event& iEvent, const edm::EventSetup& iSetup, const int iJetColl)
{
  ...
  for ( PatJetCollection::const_iterator pjet = jetsColl->begin(); pjet != jetsColl->end(); ++pjet ) {
    ...
    if ( runFatJets_ && iJetColl == 0 )
    {
      ...
      JetInfo[iJetColl].Jet_tau3[JetInfo[iJetColl].nJet] = ( pjet->hasUserFloat("Njettiness:tau3") ? pjet->userFloat("Njettiness:tau3") : pjet->userFloat("NjettinessAK8:tau3") );
      // SoftDrop kinematics
      ...
      // ECFNs
      if(pjet->isPFJet()) {
	std::vector<reco::CandidatePtr> pfConstituents = pjet->getJetConstituents();                                                                        
	...
	ECF_->calcECFN(beta,lFiltered,true);
	JetInfo[iJetColl].Jet_e2_b1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["2_2"]);
        JetInfo[iJetColl].Jet_e3_b1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_3"]);
        JetInfo[iJetColl].Jet_e3_v1_b1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_1"]);
        JetInfo[iJetColl].Jet_e3_v2_b1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_2"]);
	JetInfo[iJetColl].Jet_e4_v1_b1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["4_1"]);
        JetInfo[iJetColl].Jet_e4_v2_b1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["4_2"]);
	beta=2;
	ECF_->calcECFN(beta,lFiltered);
	JetInfo[iJetColl].Jet_e2_b2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["2_2"]);
        JetInfo[iJetColl].Jet_e3_b2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_3"]);
        JetInfo[iJetColl].Jet_e3_v1_b2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_1"]);
        JetInfo[iJetColl].Jet_e3_v2_b2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_2"]);
        JetInfo[iJetColl].Jet_e4_v1_b2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["4_1"]);
        JetInfo[iJetColl].Jet_e4_v2_b2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["4_2"]);
	...
	ECF_->calcECFN(betaSD,lSDFiltered,true);
        JetInfo[iJetColl].Jet_e2_sdb1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["2_2"]);
        JetInfo[iJetColl].Jet_e3_sdb1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_3"]);
        JetInfo[iJetColl].Jet_e3_v1_sdb1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_1"]);
        JetInfo[iJetColl].Jet_e3_v2_sdb1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_2"]);
        JetInfo[iJetColl].Jet_e4_v1_sdb1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["4_1"]);
        JetInfo[iJetColl].Jet_e4_v2_sdb1[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["4_2"]);
        betaSD=2;
        ECF_->calcECFN(betaSD,lSDFiltered);
        JetInfo[iJetColl].Jet_e2_sdb2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["2_2"]);
        JetInfo[iJetColl].Jet_e3_sdb2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_3"]);
        JetInfo[iJetColl].Jet_e3_v1_sdb2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_1"]);
        JetInfo[iJetColl].Jet_e3_v2_sdb2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["3_2"]);
        JetInfo[iJetColl].Jet_e4_v1_sdb2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["4_1"]);
        JetInfo[iJetColl].Jet_e4_v2_sdb2[JetInfo[iJetColl].nJet]      = float(ECF_->manager->ecfns["4_2"]);
	*/ }
    }
    if ( runFatJets_ && runSubJets_ && iJetColl == 0 )
    {
    ...
    if ( runFatJets_ && iJetColl == 0 )
    {
      ...
      float tau3 = JetInfo[iJetColl].Jet_tau3[JetInfo[iJetColl].nJet];
      
      // re-calculate N-subjettiness
      recalcNsubjettiness(*pjet,tau1,tau2,tau3,currentAxes);
      ...
      {
        JetInfo[iJetColl].Jet_tauAxis3_px[JetInfo[iJetColl].nJet] = currentAxes[2].px();
        JetInfo[iJetColl].Jet_tauAxis3_py[JetInfo[iJetColl].nJet] = currentAxes[2].py();
        JetInfo[iJetColl].Jet_tauAxis3_pz[JetInfo[iJetColl].nJet] = currentAxes[2].pz();
      }
    }
    ...
    float lepPHI = -100.;
    float lepTYPE = 0.;
    float exkT3subjet_1_pt = -100.;
    float exkT3subjet_1_eta = -100.;
    float exkT3subjet_1_phi = -100.;
    float exkT3subjet_1_m = -100.;
    float exkT3subjet_2_pt = -100.;
    float exkT3subjet_2_eta = -100.;
    float exkT3subjet_2_phi = -100.;
    float exkT3subjet_2_m = -100.;
    float exkT3subjet_3_pt = -100.;
    float exkT3subjet_3_eta = -100.;
    float exkT3subjet_3_phi = -100.;
    float exkT3subjet_3_m = -100.;
    float exkT2subjet_1_pt = -100.;
    float exkT2subjet_1_eta = -100.;
    float exkT2subjet_1_phi = -100.;
    float exkT2subjet_1_m = -100.;
    float exkT2subjet_2_pt = -100.;
    float exkT2subjet_2_eta = -100.;
    float exkT2subjet_2_phi = -100.;
    float exkT2subjet_2_m = -100.;
    float exkT4subjet_1_pt = -100.;
    float exkT4subjet_1_eta = -100.;
    float exkT4subjet_1_phi = -100.;
    float exkT4subjet_1_m = -100.;
    float exkT4subjet_2_pt = -100.;
    float exkT4subjet_2_eta = -100.;
    float exkT4subjet_2_phi = -100.;
    float exkT4subjet_2_m = -100.;
    float exkT4subjet_3_pt = -100.;
    float exkT4subjet_3_eta = -100.;
    float exkT4subjet_3_phi = -100.;
    float exkT4subjet_3_m = -100.;
    float exkT4subjet_4_pt = -100.;
    float exkT4subjet_4_eta = -100.;
    float exkT4subjet_4_phi = -100.;
    float exkT4subjet_4_m = -100.;
    float lsf = -100.;
    float lmd = -100.;
    float lsf2 = -100.;
    float lmd2 = -100.;
    float lsf4 = -100.;
    float lmd4 = -100.;
    float exkT3subjet_sjindex = -100.;
    float exkT2subjet_sjindex = -100.;
    ...
    if( lepPT > 0){
	  ...
	  if (matching_index > -1){
	    ...
	    exkT3subjet_1_eta = subjets[0].eta();
	    exkT3subjet_1_phi = subjets[0].phi();
	    exkT3subjet_1_m = subjets[0].m();
	    exkT3subjet_2_pt = subjets[1].pt();
	    exkT3subjet_2_eta = subjets[1].eta();
	    exkT3subjet_2_phi = subjets[1].phi();
	    exkT3subjet_2_m = subjets[1].m();
	    exkT3subjet_3_pt = subjets[2].pt();
	    exkT3subjet_3_eta =  subjets[2].eta();
	  ...
	  int nSubJets2 = 2;
	  std::vector<fastjet::PseudoJet> subjets2 = sorted_by_pt(clust_seq_2.exclusive_jets_up_to(nSubJets2));
	  int matching_index2 = -1; double matching_dR2 = 9999.9999;
	  for (size_t i = 0; i< subjets2.size(); i++){
	    double pair_dR2 = reco::deltaR(subjets2[i].eta(), subjets2[i].phi(), lepETA, lepPHI);
	    if (pair_dR2 < matching_dR2){matching_index2 = i; matching_dR2 = pair_dR2;}
	  }
	  if (matching_index2 > -1){
	    reco::Candidate::PolarLorentzVector SJ2 (subjets2[matching_index2].pt(), subjets2[matching_index2].eta(), subjets2[matching_index2].phi(), subjets2[matching_index2].m());
	    reco::Candidate::PolarLorentzVector lep (lepPT, lepETA, lepPHI, 0);
	    lsf2 = lep.Pt()/SJ2.Pt();
	    lmd2 = (SJ2 - lep).M()/SJ2.M();
	    exkT2subjet_sjindex = matching_index2;
	    exkT2subjet_1_pt = subjets2[0].pt();
	    exkT2subjet_1_eta = subjets2[0].eta();
	    exkT2subjet_1_phi = subjets2[0].phi();
	    exkT2subjet_1_m = subjets2[0].m();
	    exkT2subjet_2_pt = subjets2[1].pt();
	    exkT2subjet_2_eta = subjets2[1].eta();
	  ...
	  int nSubJets4 = 4;
	  std::vector<fastjet::PseudoJet> subjets4 = sorted_by_pt(clust_seq_4.exclusive_jets_up_to(nSubJets4)); 
	  int matching_index4 = -1; double matching_dR4 = 9999.9999;
	  for (size_t i = 0; i< subjets4.size(); i++){
	    double pair_dR4 = reco::deltaR(subjets4[i].eta(), subjets4[i].phi(), lepETA, lepPHI);
	    if (pair_dR4 < matching_dR4){matching_index4 = i; matching_dR4 = pair_dR4;}
	  }
	  if (matching_index4 > -1){
	    reco::Candidate::PolarLorentzVector SJ4 (subjets4[matching_index4].pt(), subjets4[matching_index4].eta(), subjets4[matching_index4].phi(), subjets4[matching_index4].m());
	    reco::Candidate::PolarLorentzVector lep (lepPT, lepETA, lepPHI, 0);
	    lsf4 = lep.Pt()/SJ4.Pt();
	    lmd4 = (SJ4 - lep).M()/SJ4.M();
	    exkT4subjet_sjindex = matching_index4;
	    exkT4subjet_1_pt = subjets4[0].pt();
	    exkT4subjet_1_eta = subjets4[0].eta();
	    exkT4subjet_1_phi = subjets4[0].phi();
	    exkT4subjet_1_m = subjets4[0].m();
	    exkT4subjet_2_pt = subjets4[1].pt();
	    exkT4subjet_2_eta = subjets4[1].eta();
	    exkT4subjet_2_phi = subjets4[1].phi();
	    exkT4subjet_2_m = subjets4[1].m();
	    exkT4subjet_3_pt = subjets4[2].pt();
	    exkT4subjet_3_eta = subjets4[2].eta();
	    exkT4subjet_3_phi = subjets4[2].phi();
	    exkT4subjet_3_m = subjets4[2].m();
	    exkT4subjet_4_pt = subjets4[3].pt();
	    exkT4subjet_4_eta = subjets4[3].eta();
	  ...
	  for (size_t i = 0; i< subjetsIn.size(); i++){
	    double pair_dRIn = reco::deltaR(subjetsIn[i].eta(), subjetsIn[i].phi(), lepETA, lepPHI);
	    if (pair_dRIn < matching_dRIn){matching_indexIn = i; matching_dRIn = pair_dRIn;}
	  }
	  if (matching_indexIn > -1){
	    reco::Candidate::PolarLorentzVector SJIn (subjetsIn[matching_indexIn].pt(), subjetsIn[matching_indexIn].eta(), subjetsIn[matching_indexIn].phi(), subjetsIn[matching_indexIn].m());
	    reco::Candidate::PolarLorentzVector lep (lepPT, lepETA, lepPHI, 0);
	    JetInfo[iJetColl].Jet_LSF_Incl_LSF[JetInfo[iJetColl].nJet] = lep.Pt()/SJIn.Pt();
	    JetInfo[iJetColl].Jet_LSF_Incl_LMD[JetInfo[iJetColl].nJet] = (SJIn - lep).M()/SJIn.M();
	    JetInfo[iJetColl].Jet_LSF_Incl_nSubjets[JetInfo[iJetColl].nJet] = JetInfo[iJetColl].nSubjetsIn;
	    JetInfo[iJetColl].Jet_LSF_Incl_sjIndex[JetInfo[iJetColl].nJet] = matching_indexIn;
	    for (size_t subIn = 0; subIn < subjetsIn.size(); subIn++){
	      JetInfo[iJetColl].Jet_LSF_Incl_sjPT[JetInfo[iJetColl].nSubjetsIn] = subjetsIn[subIn].pt();
	      JetInfo[iJetColl].Jet_LSF_Incl_sjETA[JetInfo[iJetColl].nSubjetsIn] = subjetsIn[subIn].eta();
	      JetInfo[iJetColl].Jet_LSF_Incl_sjPHI[JetInfo[iJetColl].nSubjetsIn] = subjetsIn[subIn].phi();
	      JetInfo[iJetColl].Jet_LSF_Incl_sjM[JetInfo[iJetColl].nSubjetsIn] = subjetsIn[subIn].m();	       
	      ++JetInfo[iJetColl].nSubjetsIn;
	  }    
	  }
    }
    else{
      JetInfo[iJetColl].Jet_LSF_Incl_LSF[JetInfo[iJetColl].nJet] = -100.;
      JetInfo[iJetColl].Jet_LSF_Incl_LMD[JetInfo[iJetColl].nJet] = -100.;
    ...
    JetInfo[iJetColl].Jet_LSF_lepTYPE[JetInfo[iJetColl].nJet] = lepTYPE;
    JetInfo[iJetColl].Jet_LSF_ExkT3_LSF[JetInfo[iJetColl].nJet] = lsf;
    JetInfo[iJetColl].Jet_LSF_ExkT3_LMD[JetInfo[iJetColl].nJet] = lmd;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sjIndex[JetInfo[iJetColl].nJet] = exkT3subjet_sjindex;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj1PT[JetInfo[iJetColl].nJet] = exkT3subjet_1_pt;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj1ETA[JetInfo[iJetColl].nJet] = exkT3subjet_1_eta;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj1PHI[JetInfo[iJetColl].nJet] = exkT3subjet_1_phi;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj1M[JetInfo[iJetColl].nJet] = exkT3subjet_1_m;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj2PT[JetInfo[iJetColl].nJet] = exkT3subjet_2_pt;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj2ETA[JetInfo[iJetColl].nJet] = exkT3subjet_2_eta;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj2PHI[JetInfo[iJetColl].nJet] = exkT3subjet_2_phi;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj2M[JetInfo[iJetColl].nJet] = exkT3subjet_2_m;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj3PT[JetInfo[iJetColl].nJet] = exkT3subjet_3_pt;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj3ETA[JetInfo[iJetColl].nJet] = exkT3subjet_3_eta;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj3PHI[JetInfo[iJetColl].nJet] = exkT3subjet_3_phi;
    JetInfo[iJetColl].Jet_LSF_ExkT3_sj3M[JetInfo[iJetColl].nJet] = exkT3subjet_3_m;
    JetInfo[iJetColl].Jet_LSF_ExkT4_LSF[JetInfo[iJetColl].nJet] = lsf4;
    JetInfo[iJetColl].Jet_LSF_ExkT4_LMD[JetInfo[iJetColl].nJet] = lmd4;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sjIndex[JetInfo[iJetColl].nJet] = exkT4subjet_sjindex;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj1PT[JetInfo[iJetColl].nJet] = exkT4subjet_1_pt;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj1ETA[JetInfo[iJetColl].nJet] = exkT4subjet_1_eta;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj1PHI[JetInfo[iJetColl].nJet] = exkT4subjet_1_phi;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj1M[JetInfo[iJetColl].nJet] = exkT4subjet_1_m;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj2PT[JetInfo[iJetColl].nJet] = exkT4subjet_2_pt;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj2ETA[JetInfo[iJetColl].nJet] = exkT4subjet_2_eta;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj2PHI[JetInfo[iJetColl].nJet] = exkT4subjet_2_phi;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj2M[JetInfo[iJetColl].nJet] = exkT4subjet_2_m;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj3PT[JetInfo[iJetColl].nJet] = exkT4subjet_3_pt;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj3ETA[JetInfo[iJetColl].nJet] = exkT4subjet_3_eta;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj3PHI[JetInfo[iJetColl].nJet] = exkT4subjet_3_phi;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj3M[JetInfo[iJetColl].nJet] = exkT4subjet_3_m;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj4PT[JetInfo[iJetColl].nJet] = exkT4subjet_4_pt;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj4ETA[JetInfo[iJetColl].nJet] = exkT4subjet_4_eta;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj4PHI[JetInfo[iJetColl].nJet] = exkT4subjet_4_phi;
    JetInfo[iJetColl].Jet_LSF_ExkT4_sj4M[JetInfo[iJetColl].nJet] = exkT4subjet_4_m;
    JetInfo[iJetColl].Jet_LSF_ExkT2_LSF[JetInfo[iJetColl].nJet] = lsf2;
    JetInfo[iJetColl].Jet_LSF_ExkT2_LMD[JetInfo[iJetColl].nJet] = lmd2;
    JetInfo[iJetColl].Jet_LSF_ExkT2_sjIndex[JetInfo[iJetColl].nJet] = exkT2subjet_sjindex;
    JetInfo[iJetColl].Jet_LSF_ExkT2_sj1PT[JetInfo[iJetColl].nJet] = exkT2subjet_1_pt;
    JetInfo[iJetColl].Jet_LSF_ExkT2_sj1ETA[JetInfo[iJetColl].nJet] = exkT2subjet_1_eta;
    JetInfo[iJetColl].Jet_LSF_ExkT2_sj1PHI[JetInfo[iJetColl].nJet] = exkT2subjet_1_phi;
    JetInfo[iJetColl].Jet_LSF_ExkT2_sj1M[JetInfo[iJetColl].nJet] = exkT2subjet_1_m;
    JetInfo[iJetColl].Jet_LSF_ExkT2_sj2PT[JetInfo[iJetColl].nJet] = exkT2subjet_2_pt;
    JetInfo[iJetColl].Jet_LSF_ExkT2_sj2ETA[JetInfo[iJetColl].nJet] = exkT2subjet_2_eta;
    JetInfo[iJetColl].Jet_LSF_ExkT2_sj2PHI[JetInfo[iJetColl].nJet] = exkT2subjet_2_phi;
    JetInfo[iJetColl].Jet_LSF_ExkT2_sj2M[JetInfo[iJetColl].nJet] = exkT2subjet_2_m;
...
// -------------- recalcNsubjettiness ----------------
template<typename IPTI,typename VTX>
void BTagAnalyzerT<IPTI,VTX>::recalcNsubjettiness(const pat::Jet & jet, float & tau1, float & tau2, float & tau3, std::vector<fastjet::PseudoJet> & currentAxes) const
{
  std::vector<fastjet::PseudoJet> fjParticles;
  ...
  tau3 = njettiness.getTau(3, fjParticles);
